...
class StaticVariety(bpy.types.Operator):
    bl_label = "Static variety"
    bl_idname = "geometry.static_variety"
    bl_description = ("Adds still copies of a dependent object while another"
                      " point moves on curve. Select the object (active) and "
                      "the point")
